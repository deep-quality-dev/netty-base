...
import static com.useful.client.utils.Logging.logi;
...
public class HeartbeatHandler extends ChannelInboundHandlerAdapter {
    ...
    public HeartbeatHandler(TCPClient tcpClient, ClientListener clientListener) {
        ...
        reconnectTimeout = PropertyUtils.getInstance().getInteger("client.reconnectTimeout");
    }
...
//        super.channelRead(ctx, msg);
    ...
    public void userEventTriggered(ChannelHandlerContext ctx, Object evt) throws Exception {
        ...
        if (evt instanceof IdleStateEvent) {
            ...
            logi(ctx.channel().remoteAddress()+", 超时类型：" + type);
        }
    }
