...
public class TCPClient {
    ...
    public TCPClient(String clientId) {
        ...
        this.host = PropertyUtils.getString("tcp.host");
        this.port = PropertyUtils.getInteger("tcp.port");

        this.READER_IDLE_TIME_SECONDS = PropertyUtils.getInteger("socket.READER_IDLE_TIME_SECONDS");
        this.WRITER_IDLE_TIME_SECONDS = PropertyUtils.getInteger("socket.WRITER_IDLE_TIME_SECONDS");
        this.ALL_IDLE_TIME_SECONDS = PropertyUtils.getInteger("socket.ALL_IDLE_TIME_SECONDS");

        this.reconnectTimeout = PropertyUtils.getInteger("client.reconnectTimeout");
    }
